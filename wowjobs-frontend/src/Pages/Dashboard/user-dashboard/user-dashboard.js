...
import UserCourses from "../../../Components/Dashboard/user-dashboard-components/userCourses/userCourses";
import UserKuppi from "../../../Components/Dashboard/user-dashboard-components/userKuppi/userKuppi";
import UserFindJob from "../../../Components/Dashboard/user-dashboard-components/userFindJob";
import UserApplied from "../../../Components/Dashboard/user-dashboard-components/userApplied";
import UserProfile from "../../../Components/Dashboard/user-dashboard-components/userProfile/userProfile";
import UserFriends from "../../../Components/Dashboard/user-dashboard-components/userFriends";
import UserConsult from "../../../Components/Dashboard/user-dashboard-components/UserConsult";
        ...
        <Container fluid>
            <Row>
                <Col md={2}>
                    <Nav defaultActiveKey="/home" className="flex-column bg-light text-white sidebar" style={{minWidth: '250px', height: '100vh'}}>
                        ...
                        <Nav.Link onClick={() => setActiveComponent("dashboard")}
                                  className="sidebar-text "><IoHome/> Dashboard</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("courses")}
                                  className="sidebar-text"><FaGraduationCap /> Courses</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("consult")}
                                  className="sidebar-text"><FaChalkboardTeacher/> Get a Consult</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("kuppi")} className="sidebar-text"><PiBooks/> Kuppi</Nav.Link>

                        <hr className="border-dark mt-4 mb-4 w-75 align-self-center"/>

                        <Nav.Link onClick={() => setActiveComponent("findJob")}
                                  className="sidebar-text "><BsFillBuildingsFill/> Find a Job</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("applied")}
                                  className="sidebar-text"><IoBagCheckOutline /> Applied</Nav.Link>

                        <hr className="border-dark mt-4 mb-4 w-75 align-self-center"/>

                        <Nav.Link onClick={() => setActiveComponent("profile")}
                                  className="sidebar-text "><CgProfile/> Profile</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("friends")}
                                  className="sidebar-text"><FaPeopleGroup/> Friends</Nav.Link>
                        <Nav.Link onClick={() => window.location.href = 'http://localhost:3001/'}
                                  className="sidebar-text"><TiMessages /> Messages</Nav.Link>
                ...
                <Col md={10}>
                    ...
                    {activeComponent === "consult" && <UserConsult/>}
                    {activeComponent === "courses" && <UserCourses/>}
                    {activeComponent === "kuppi" && <UserKuppi/>}
                    {activeComponent === "findJob" && <UserFindJob/>}
                    {activeComponent === "applied" && <UserApplied/>}
                    {activeComponent === "profile" && <UserProfile/>}
                    {activeComponent === "friends" && <UserFriends/>}
                </Col>
            </Row>
        </Container>
    );
