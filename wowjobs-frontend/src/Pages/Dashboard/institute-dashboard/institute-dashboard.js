...
import {IoHome, IoSettingsOutline, IoTimeOutline} from "react-icons/io5";
import {FaGraduationCap} from "react-icons/fa";
import "./institute-dashboard.css";
import {PiStudent} from "react-icons/pi";
import {CgProfile} from "react-icons/cg";
import InstituteDashboard from "../../../Components/Dashboard/institute-dashboard/InstituteDashboard";
import InstituteProfile from "../../../Components/Dashboard/institute-dashboard/InstituteProfile";
import InstituteCourses from "../../../Components/Dashboard/institute-dashboard/InstituteCourses";
import InstituteShedules from "../../../Components/Dashboard/institute-dashboard/InstituteShedules";
import InstituteStudents from "../../../Components/Dashboard/institute-dashboard/InstituteStudents";
import InstituteNotifications from "../../../Components/Dashboard/institute-dashboard/InstituteNotifications";
import InstituteSettings from "../../../Components/Dashboard/institute-dashboard/InstituteSettings";
    ...
    return (
        <Container fluid>
            <Row>
                <Col md={2}>
                    <Nav defaultActiveKey="/home" className="flex-column bg-light text-white sidebar" style={{minWidth: '250px', height: '100vh'}}>
                        ...
                        <Nav.Link onClick={() => setActiveComponent("profile")}
                                  className="isidebar-text "><CgProfile/> Profile</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("dashboard")}
                                  className="isidebar-text "><IoHome/> Dashboard</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("courses")}
                                  className="isidebar-text"><FaGraduationCap /> Courses</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("schedules")}
                                  className="isidebar-text"><IoTimeOutline/> Schedules</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("students")}
                                  className="isidebar-text"><PiStudent  /> Students</Nav.Link>

                        <hr className="border-dark mt-4 mb-4 w-75 align-self-center"/>

                        <Nav.Link onClick={() => window.location.href = 'http://localhost:3001/'}
                                  className="isidebar-text"><TiMessages /> Messages</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("notifications")}
                                  className="isidebar-text"><GoBell /> Notifications</Nav.Link>
                        <Nav.Link onClick={() => setActiveComponent("settings")}
                                  className="isidebar-text"><IoSettingsOutline /> Settings</Nav.Link>
                ...
                <Col md={10}>
                    {activeComponent === "profile" && <InstituteProfile/>}
                    {activeComponent === "dashboard" && <InstituteDashboard/>}
                    {activeComponent === "courses" && <InstituteCourses/>}
                    {activeComponent === "schedules" && <InstituteShedules/>}
                    {activeComponent === "students" && <InstituteStudents />}
                    {/*{activeComponent === "messages" && </>}*/}
                    {activeComponent === "notifications" && <InstituteNotifications/>}
                    {activeComponent === "settings" && <InstituteSettings/>}
                </Col>
            </Row>
        </Container>
    );
